...
const NuevoPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validacion para el nuevo password
    ...
    try {
      // envio del nuevo password a la DB
  ...
  return (
    <>
      <div>
            <h1 className="text-indigo-600 font-black text-4xl md:text-6xl">Reestablece tu password y no Pierdas Acceso a {""}<span className="text-black">tus Pacientes</span></h1>
      </div>
